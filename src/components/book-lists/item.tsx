    ...
    <div className="border-t border-[#CCCCCC] lg:flex">
      ...
      <div className="mb-[15px] lg:mb-0 flex lg:flex-1 lg:mt-[5px]">
        <div onClick={handleClickOnEdition}>
          <BookCover
            image={cover}
            className="w-[75px] lg:w-[50px] ml-2.5 mb-[15px] lg:mx-[5px] cursor-pointer"
        ...
        <div className="mx-2.5 lg:mx-0 lg:flex lg:flex-1">
          <div className="lg:p-[5px] lg:flex-1">
            <p
              className="text-base lg:text-[17px] lg:font-bold leading-[19px] flex-wrap cursor-pointer hover:underline"
