...
import {
  DiscoverBooksList,
  type DiscoverBooksItemProps,
} from "../../components/home/discover-books-list";
...
export const HomeDesktop = () => {
  ...
  const mostRatedBooksStringified = useMemo(
    () => JSON.stringify(mostRatedBooks),
    [mostRatedBooks]
  );
  ...
  const mostRatedBooksSuggestion = useMemo(() => {
    if (mostRatedBooks.suggestion) {
      ...
      const genres = mainSuggestion.book.relatedGenres
        .slice(0, totalGenresShown)
      ...
      <div className="max-w-[970px] mx-auto pt-[325px]">
        ...
        <div className="flex">
          <div className="w-[625px] mr-2.5 ml-2">
            <div className="flex">
              <div className="w-[280px] mr-[40px]">
                <p className="text-lg">Deciding what to read next?</p>
              ...
              <div className="w-[280px]">
                <p className="text-lg">What are your friends reading?</p>
                <p className="text-sm my-[18px]">
            ...
            <div className="bg-[#f4f2e9] rounded pt-[15px] pb-5">
              ...
              <DiscoverBooksList
                ...
                list={discoverMostRatedBooks}
                mainSuggestion={mostRatedBooksSuggestion}
              />
              <DiscoverBooksList
                title="Best Rated Books"
                list={discoverBestRatedBooks}
                mainSuggestion={bestRatedBooksSuggestion}
              />
            </div>
            ...
            <p className="mb-2.5 text-lg">
              Goodreads Choice Awards: Readers' Favorite Books 2025
            </p>

            <div className="flex">
              <div className="mt-2.5 mr-5 w-[110px]">
                <img
                  src={CHOICE_AWARDS_IMG_URL}
                  alt="Choice Awards"
              ...
              <div className="flex flex-1">
                <LinksListDesktop
                  list={awardsCategoriesLinksList}
                  columns={2}
                  className="mb-[0.8em]"
                />
              </div>
          ...
          <div className="w-[300px] ml-2 mt-[160px]">
            ...
            <p className="text-lg">Are you an author or a publisher?</p>
