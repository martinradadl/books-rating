  ...
  return (
    <div className="p-3">
      <div ref={autocompleteRef}>
        <AutocompleteInput
          inputComponent={
            <GenresSearchBarMobile onChange={debouncedHandleOnChangeSearch} />
          }
      ...
      <div className="max-w-[495px] mx-auto text-sm">
        <p>
          ...
          move.” –
          <span className="font-bold text-[#00635D] cursor-pointer hover:underline">
            {" "}
            Douglas Adams
          </span>
        </p>
        <p className="text-[#00635D] cursor-pointer hover:underline">
          23,477 people liked this
        </p>
      </div>
